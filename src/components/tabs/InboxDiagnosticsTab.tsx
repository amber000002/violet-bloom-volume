      ...
      {activeReport === "analysis" && (diagnostics?.analysisReport || journeyAnalysis) && (
        ...
        >
          ...
          >
            ...
            {/* Journey trend — month-level (journeys carry no year, so daily/weekly granularity isn't possible) */}
            {journeyAnalysis?.monthlyOverview && journeyAnalysis.monthlyOverview.length > 0 && (
              <div className="mt-6 pt-6 border-t border-border">
                <div className="text-xs font-semibold text-muted-foreground mb-2">Journeys — Monthly Trend</div>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-border">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  * Journey trend is rendered as a monthly table because journey exports don't include the year.
                </p>
              </div>
            )}
          </CollapsibleSection>
